...
export const allCmdDefault = [
    new Cmd(
        ...
        'SCEP',
        'scepserver',
        `./scep/scepserver-${window.__GOOS__}-${window.__GOARCH__} -allowrenew 0 -challenge nanomdm -debug`,
        [],
        Status.INACTIVE,
        true,
        ),
    ...
    new Cmd(
        ...
        'Nanomdm',
        'nanomdm',
        `./nanomdm/nanomdm-${window.__GOOS__}-${window.__GOARCH__} -ca ./ca.pem -api nanomdm -debug`,
        [],
        Status.INACTIVE,
        true),
    new Cmd(
    ...
    new Cmd(
        ...
        'Push certificate',
        'push_cert',
        `cat ./certificates/*.pem ./certificates/*.key | curl -T - -u nanomdm:nanomdm 'http://127.0.0.1:9000/v1/pushcert'`,
        [],
        Status.INACTIVE,
        false,
        function (store) {
